...
| The Last Shift | Lalit R. Mishra | Lalit R. Mishra | Greyveil Editions | 2026 | `assets/books/the-last-shift/book.json`; `assets/books/the-last-shift/chapters/02-copyright.json` | High | None found in reviewed files. |
